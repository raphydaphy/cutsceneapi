...
public class SplinePath implements Path
{
	...
	@Override
	public SplinePath withPoint(Vector3f point)
	{
	...
	@Override
	public SplinePath withPoint(float x, float y, float z)
	{
	...
	public SplinePath build()
	{
		...
		{
			calcNaturalCubic(points, Vector3f::getX, xCubics);
			calcNaturalCubic(points, Vector3f::getY, yCubics);
			calcNaturalCubic(points, Vector3f::getZ, zCubics);
		}
		return this;
	}
