    ...
    public static class Handler extends MessageHandler<CutsceneCommandPacket> {
        ...
        public void handle(PacketContext ctx, CutsceneCommandPacket message) {
            ...
            if (command == Command.JOIN_COPY_WORLD || command == Command.JOIN_VOID_WORLD || command == Command.JOIN_CACHED_WORLD) {
                ...
                client.player.sendMessage(Text.of("Serialized Chunk"), true);
                ...
                if (!tag.isEmpty()) {
                    ...
                    client.player.sendMessage(new TranslatableText("command.cutsceneapi.deserialized"), false);
                } else {
                    client.player.sendMessage(new TranslatableText("command.cutsceneapi.didntserialize"), false);
                }
