...
public class CutsceneChunkSerializer
{
	...
	public static Chunk deserialize(World world_1, ChunkPos chunkPos, CompoundTag chunkTag)
	{
		...
		} else
		{
			...
			{
				Iterator var26 = BlockPos.iterateBoxPositions(chunkPos.getStartX(), 0, chunkPos.getStartZ(), chunkPos.getEndX(), 255, chunkPos.getEndZ()).iterator();

				while (var26.hasNext())
				{
					BlockPos blockPos_1 = (BlockPos) var26.next();
