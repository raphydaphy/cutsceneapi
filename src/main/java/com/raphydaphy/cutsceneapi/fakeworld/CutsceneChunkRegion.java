...
public class CutsceneChunkRegion implements IWorld
{
	...
	public boolean setBlockState(BlockPos blockPos_1, BlockState blockState_1, int int_1)
	{
		...
		{
			this.cutsceneWorld.method_19282(blockPos_1, blockState_2, blockState_1);
		}
	...
	@Override
	public void method_8444(PlayerEntity playerEntity_1, int int_1, BlockPos blockPos_1, int int_2)
	{
	}
